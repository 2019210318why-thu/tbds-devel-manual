...
| hermespartion='20150706' or hermespartion in ('20150706', '20150707') or thedate='20150706' | 注意：过滤条件可以进行and与or的组合（但最外层必须是and ）</br></br>例子如下：hermespartion in (20140908) and hermestopic='qqface' and (ddwuid='1' or ddwuid='2' or (dwinserttime>=20140908202626 and dwinserttime<=20140908203026)) | |
