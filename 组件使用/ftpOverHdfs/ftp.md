...
public class FTPUtils {
    ...
    */
    public DownloadStatus download(String remote, String local)
        ...
        // 检查远程文件是否存在
        FTPFile[] files = ftpClient.listFiles(new String(remote.getBytes(
                        "UTF-8"), "iso-8859-1"));
    ...
    */
    ...
    public void syncRemoteFile(String pathName, String loaclDir)
        throws IOException {
        if (pathName.startsWith("/") && pathName.endsWith("/")) {
            String directory = pathName;
            // 更换目录到当前目录
                ...
                if (file.isFile()) {
                    ...
                    if (!loacalFile.exists()) {
                        System.out.println("下载：" + pathName + "/" +
                            file.getName());
                        download(pathName + "/" + file.getName(),
                            loaclDir + "/" + file.getName());
                    }
                } else if (file.isDirectory()) {
    ...
    public UploadStatus createDirecroty(String remote, FTPClient ftpClient)
        ...
        if (!directory.equalsIgnoreCase("/") &&
                !ftpClient.changeWorkingDirectory(
                    new String(directory.getBytes("UTF-8"), "iso-8859-1"))) {
            ...
            while (true) {
                String subDirectory = new String(
                    remote.substring(start, end).getBytes("UTF-8"),"iso-8859-1"
                );
    ...
    */
    public UploadStatus uploadFile(String remoteFile, File localFile,
        ...
        try {
            ...
            out = ftpClient.appendFileStream(new String(remoteFile.getBytes(
                            "UTF-8"), "iso-8859-1"));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(myFtp.upload("e:/安装Eclipse反编译插件1.doc",
                    "/admin/安装Eclipse反编译插件1.doc"));
...
public enum DownloadStatus {Remote_File_Noexist,
    Local_Bigger_Remote,
...
public enum UploadStatus {Create_Directory_Fail,
...
## javaclient 连接启用ftps的 ftpserver
...
public class FTPSTest {
    ...
    private static void connect(String active, String host)
        throws Exception {
        ...
        System.out.println("storeFile: " +
            ftpsClient.storeFile("key_path.jks", fs));

        ftpsClient.changeWorkingDirectory("/ftp/yiwen2/all/20170615"); //cd dir

        FTPFile[] files = ftpsClient.listFiles();
        System.out.println("List file length of /ftp/yiwen2/all/20170615:" +
            files.length);
